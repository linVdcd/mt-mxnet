...
def add_fit_args(parser):
    ...
    train.add_argument('--wd', type=float, default=0.0005,
                       help='weight decay for sgd')
    train.add_argument('--batch-size', type=int, default=128,
                       help='the batch size')
    train.add_argument('--disp-batches', type=int, default=50,
                       help='show progress for every n batches')
    train.add_argument('--model-prefix', type=str,default='model/model',
                       help='model prefix')
