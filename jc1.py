...
def get_symbol(num_classes,**kwargs):
    ...
    conv1 = mx.symbol.Convolution(name='conv1', data=data, num_filter=16, pad=(1, 1), kernel=(3, 3), stride=(1, 1),
                                  no_bias=False)
    ...
    fire2_expand1x1 = mx.symbol.Convolution(name='fire2_expand1x1', data=fire2_squeeze1x1, num_filter=32,
    ...
    fire2_expand3x3 = mx.symbol.Convolution(name='fire2_expand3x3', data=fire2_squeeze1x1, num_filter=16,
    ...
    fire4_expand1x1 = mx.symbol.Convolution(name='fire4_expand1x1', data=fire4_squeeze1x1, num_filter=32,
                                            pad=(0, 0), kernel=(1, 1), stride=(1, 1), no_bias=False)
    fire4_relu_expand1x1 = mx.symbol.Activation(name='fire4_relu_expand1x1', data=fire4_expand1x1, act_type='relu')
    fire4_expand3x3 = mx.symbol.Convolution(name='fire4_expand3x3', data=fire4_squeeze1x1, num_filter=16,
                                            pad=(1, 1), kernel=(3, 3), stride=(1, 1), no_bias=False)
    ...
    fire5_expand1x1 = mx.symbol.Convolution(name='fire5_expand1x1', data=fire5_squeeze1x1, num_filter=32,
                                            pad=(0, 0), kernel=(1, 1), stride=(1, 1), no_bias=False)
    fire5_relu_expand1x1 = mx.symbol.Activation(name='fire5_relu_expand1x1', data=fire5_expand1x1, act_type='relu')
    fire5_expand3x3 = mx.symbol.Convolution(name='fire5_expand3x3', data=fire5_squeeze1x1, num_filter=16,
                                            pad=(1, 1), kernel=(3, 3), stride=(1, 1), no_bias=False)
    ...
    pool5 = mx.symbol.Pooling(name='pool5', data=fire5_concat, pooling_convention='full', pad=(0, 0), kernel=(3, 3),
                              stride=(2, 2), pool_type='max')
    fire6_squeeze1x1 = mx.symbol.Convolution(name='fire6_squeeze1x1', data=pool5, num_filter=32, pad=(0, 0),
                                             kernel=(1, 1), stride=(1, 1), no_bias=False)
    #fire6_relu_squeeze1x1 = mx.symbol.Activation(name='fire6_relu_squeeze1x1', data=fire6_squeeze1x1, act_type='relu')
    fire6_expand1x1 = mx.symbol.Convolution(name='fire6_expand1x1', data=fire6_squeeze1x1, num_filter=192,
                                            pad=(0, 0), kernel=(1, 1), stride=(1, 1), no_bias=False)
    fire6_relu_expand1x1 = mx.symbol.Activation(name='fire6_relu_expand1x1', data=fire6_expand1x1, act_type='relu')
    fire6_expand3x3 = mx.symbol.Convolution(name='fire6_expand3x3', data=fire6_squeeze1x1, num_filter=64,
                                            pad=(1, 1), kernel=(3, 3), stride=(1, 1), no_bias=False)
